      ...
      <>
        ...
        <div className="flex flex-row items-center">
          <svg
            ...
            width="22"
            height="30"
            viewBox="0 0 32.396 43.195"
          >
            <g
              id="Group_102"
              data-name="Group 102"
              transform="translate(-1106.871 -1030.805)"
            >
              <path
                id="Icon_awesome-map-marker-alt"
                data-name="Icon awesome-map-marker-alt"
                d="M14.534,42.324C2.275,24.553,0,22.729,0,16.2a16.2,16.2,0,0,1,32.4,0c0,6.531-2.275,8.355-14.534,26.126a2.026,2.026,0,0,1-3.329,0ZM16.2,22.947A6.749,6.749,0,1,0,9.449,16.2,6.749,6.749,0,0,0,16.2,22.947Z"
                transform="translate(1106.871 1030.805)"
                fill="#eb0000"
              />
              <g
                id="Group_27"
                data-name="Group 27"
                transform="translate(154 186.171)"
              >
                <path
                  id="Path_51"
                  data-name="Path 51"
                  d="M12,0A12,12,0,1,1,0,12,12,12,0,0,1,12,0Z"
                  transform="translate(957 849.829)"
                  fill="#fff"
                />
                <text
                  id="M"
                  transform="translate(961.267 867.509)"
                  fill="#eb0000"
                  font-size="16"
          ...
          {result.distance ? (
            <div className="float-right right-column ml-auto">
              <div className="flex distance items-center">
                ...
                <span className="text-[#eb0000] pl-1.5  text-lg">miles</span>
              </div>
            </div>
          ) : (
            ""
        ...
        <div className="ml-[22px] storelocation-name hover:underline  font-evogriaregular hover:font-semibold   ">
          <a className="inline-block " href={`${result.rawData.slug}`}>
            {result.rawData.name}
          </a>
        </div>
        <div className=" lp-param-results lp-subparam-hours">
          ...
          <Opening
            ...
            class="ml-[22px] mt-1 open-now-string  justify-center text-[#eb0000]"
          />
          ...
          <div className="flex mb-3  ">
            <a
              ...
              className="px-2 mr-2  text-base font-bold text-white rounded-lg drop-shadow-md bg-[#eb0000]"
            >
              View Store Detail
            </a>
            {result.rawData.displayCoordinate ? (
              <a
                ...
                className=" getdirection px-6 text-base font-bold text-white rounded-lg drop-shadow-md bg-[#eb0000]"
                rel="noopener noreferrer"
                data-city={result.rawData.address.city}
                data-country={result.rawData.address.country}
              ...
              <a
                ...
                data-country={result.rawData.address.country}
                data-region={result.rawData.address.region}
                className=" getdirection1px-6 text-base font-bold text-white rounded-lg drop-shadow-md bg-[#eb0000]"
                rel="noopener noreferrer"
              >
                Direction
              </a>
